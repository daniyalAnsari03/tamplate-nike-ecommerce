    ...
    return (
        <nav className="bg-white shadow-sm">
            <div className="container mx-auto px-4 flex justify-between items-center h-16">
                ...
                {/* Navigation Links */}
                <ul className="hidden md:flex items-center space-x-6 font-semibold ml-48 text-black text-lg">
                    <li>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center bg-gray-100 rounded-full px-4 py-1">
                        ...
                        <input
                            type="text"
                            placeholder="Search"
                            className="bg-gray-100 text-base pl-2 outline-none h-10 w-full md:w-auto" // Added w-full for mobile
                        />
                    </div>
            ...
            <div className="md:hidden">
                <ul className="flex flex-col items-center space-y-2 mt-4 text-xl text-black">
                    <li>
                        <Link href="#" className="hover:text-gray-800 ">
                            New & Featured
                        </Link>
